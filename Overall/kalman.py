...
def main(input_wav, output_wav):
    ...
    pesq_score, si_snr_score, stoi_score, sdr=metrics(audio, denoised_audio, sr)
    return pesq_score, si_snr_score, stoi_score, sdr
...
if __name__ == "__main__":
    ...
    for file in os.listdir(path):
        ...
        si_snr_score_avg+=si_snr_score
        stoi_score_avg+=stoi_score
        sdr_score_avg+=sdr
